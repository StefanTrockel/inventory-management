export default {
  ...
  tasks: {
    ...
    defaults: {
      reviewQ4: "第4四半期の在庫レベルを確認",
      approveTokyo: "東京倉庫の注文を承認",
      updateReorderPoints: "回路基板の再注文点を更新",
      reviewMonthlySpending: "月次支出レポートを確認",
    },
  },
  ...
  backlog: {
    title: "バックログ管理",
    description: "バックログ品目の追跡と優先順位付け",
    high: "高優先度",
    medium: "中優先度",
    low: "低優先度",
    loading: "バックログを読み込み中...",
    empty: "現在のフィルター条件に一致するバックログ品目はありません。",
    table: {
      sku: "SKU",
      itemName: "品目名",
      warehouse: "倉庫",
